...
<html lang="pt-br">
	<head>
		...
		<title>220V Elétrica e Segurança Eletrônica</title>
	...
	<body data-spy="scroll" data-target=".navbar" data-offset="50">
		...
		<nav class="navbar navbar-expand-lg fixed-top">
			<div class="container">
				<a class="navbar-brand" href="#"><img src="images/logo.png" alt="Marshmallow"></a>
		...
		<div class="page-body-wrapper">
									...
									<div data-aos="zoom-in-up">
										<div class="banner-title">
											<h3 class="font-weight-medium">
												Soluções Elétricas e Segurança Eletrônica
											</h3>
										</div>
										<p class="mt-3">Instalação e manutenção de sistemas elétricos, 

											<br>
											E sistemas de segurança como Câmeras, Cerca elétrica, Motor de portão...
										</p>
										<a href="#services" class="btn btn-secondary mt-3">Saiba Mais</a>
									</div>
			...
			<section class="our-services" id="services">
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<h5 class="text-dark">Conheça alguns de nossos</h5>
							<h3 class="font-weight-medium text-dark mb-5">Serviços</h3>
						</div>
					</div>
					<div class="row" data-aos="fade-up">
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="images/casa.svg" alt="integrated-marketing" data-aos="zoom-in">
								<h6 class="text-dark mb-3 mt-4 font-weight-medium">Elétrica 
									residencial
								</h6>
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box"   data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="images/comercio.svg" alt="design-development" data-aos="zoom-in">
								<h6 class="text-dark mb-3 mt-4 font-weight-medium">Elétrica 
									Comercial
								</h6>
								<p>Lorem ipsum dolor sit amet, 
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="images/industria.svg" alt="digital-strategy" data-aos="zoom-in">
								<h6 class="text-dark mb-3 mt-4 font-weight-medium">Elétrica 
									Industrial
								</h6>
								<p>Lorem ipsum dolor sit amet, 
					...
					<div class="row" data-aos="fade-up">
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box  pb-lg-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="images/camera.svg" alt="digital-marketing" data-aos="zoom-in">
								<h6 class="text-dark mb-3 mt-4 font-weight-medium">Cameras 
									de Segurança
								</h6>
								<p>Lorem ipsum dolor sit amet, 
									pretium pretium tempor.Lorem ipsum 
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box pb-lg-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="images/cerca.svg" alt="growth-strategy" data-aos="zoom-in">
								<h6 class="text-dark mb-3 mt-4 font-weight-medium">Cerca 
									Elétrica
								</h6>
								<p>Lorem ipsum dolor sit amet, 
									pretium pretium tempor.Lorem ipsum 
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box pb-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="images/portao.svg" alt="saving-strategy" data-aos="zoom-in">
								<h6 class="text-dark mb-3 mt-4 font-weight-medium">Motor 
									de Portão
								</h6>
								<p>Lorem ipsum dolor sit amet, 
									pretium pretium tempor.Lorem ipsum 
